...
import com.cucumber.framework.PageObjects.NavigateToURL;
...
public class LoginTest {
	...
	public void i_enter_username_as(String username) throws Throwable {
		...
		//System.out.println("Enter username " +TestBase.getDriver());
	}

	@When("^I enter password as \"([^\"]*)\"$")
	public void i_enter_password_as(String password) throws Throwable {
		loginpage.setPassword(password);
		//System.out.println("Enter password " +TestBase.getDriver());
	}
	...
	public void login_should_be_successful() throws Throwable {
		loginpage.verifyMsg();
		//System.out.println("login verify for success" +TestBase.getDriver());
	}
